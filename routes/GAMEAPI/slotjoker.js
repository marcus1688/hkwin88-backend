...
router.post("/api/joker/deposit", authenticateToken, async (req, res) => {
...
router.post("/api/joker/withdraw", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    const withdrawResponse = await JokerWithdraw(user, formattedWithdrawAmount);
